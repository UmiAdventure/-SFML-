#include "Ground.h"
#include <stdexcept>
Ground::Ground(float groundY) : speed(200.f), segmentWidth(200.f), y(groundY), totalTime(0.f) {
    // 创建 4 个矩形地块拼接 (800px 宽窗口)
    for (int i = 0; i < 160; ++i) {
        sf::RectangleShape seg;
        seg.setSize(sf::Vector2f(5.f, segmentWidth));
